...
async def fundamentals(symbol: str, region: str = Query("IN")) -> Fundamentals:
    ...
    return Fundamentals(
        ...
        sector=data.get("sector"),
        industry=data.get("industry"),
        market_cap=ratios.get("Market Cap") or derived.get("market_cap"),
        pe=derived.get("pe") or ratios.get("Stock P/E") or ratios.get("PE"),
        pb=derived.get("pb"),
        book_value=ratios.get("Book Value"),
        dividend_yield=ratios.get("Dividend Yield"),
        eps=ratios.get("EPS"),
        roe=derived.get("roe"),
        roce=derived.get("roce"),
        opm=derived.get("opm"),
        npm=derived.get("npm"),
        ...
        promoter_holding=derived.get("promoter_holding") or sh.get("Promoters"),
        fii_holding=sh.get("FIIs"),
        dii_holding=sh.get("DIIs"),
